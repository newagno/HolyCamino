...
export const EXERCISES = {
  ...
  during: [
    ...
    {
      n: 'Техніка: Трекінгові палиці',
      dur: 'Під час руху',
      comic: '"Бережи коліна, а не кисті!"',
      fig: 'poles',
      steps: [
        '<b>Довжина:</b> Кут у лікті має бути 90°.',
        '<b>Темляк (петля):</b> Руку в петлю знизу вгору. Вага тіла на ремінець, не стискайте рукоятку.',
        '<b>Рух (протифаза):</b> Права нога + ліва палиця. Ставте під кутом назад і ВІДШТОВХУЙТЕСЬ.',
        '<b>Рельєф:</b> На підйомі палиці коротші на 5-10 см. На спуску — довші на 5-10 см (для опори).',
        '<b>Специфіка:</b> Тільки гумові "чобітки" (асфальт, бруківка, настили). Метал — лише для відкритого ґрунту.'
      ],
    },
    {
      n: 'Вечірня розтяжка',
