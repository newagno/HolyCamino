export const GLOBAL_GEAR = [
  ...
  { name: 'Німесил', comment: 'Універсальний протизапальний та знеболювальний засіб в аптечку', category: 'medical' },
  { name: 'Краплі для очей (штучна сльоза)', comment: 'Захист слизової від сухості через постійний вітер з океану та пил', category: 'medical' },
  ...
  { name: 'Навісний замок (кодовий, малий)', comment: 'Критично! Більшість альберге мають шафки, без замка не заселять або не зможете убезпечити речі.', category: 'gear' },
  ...
  { name: 'S-подібні гачки (2-3 шт.)', comment: 'Для підвішування косметички/рушника на металеву раму ліжка', category: 'other' },
  { name: 'Канцелярські затискачі (великі)', comment: 'Для підвішування простирадла/рушника як завіси від світла', category: 'other' },
